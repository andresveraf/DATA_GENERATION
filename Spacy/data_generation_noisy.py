...
def create_chilean_training_dataset_with_noise(train_size: int = 80000, 
    ...
    excel_examples = max(10, min(500, train_size // 5))  # At least 10, max 500, or 1/5 of training
...
def create_multi_country_training_dataset_with_noise(train_size: int = 80000, 
    ...
    excel_examples = max(20, min(500, train_size // 5))  # At least 20 for multi-country, max 500
...
def make_multi_country_docbin_with_noise(n_total: int = 100000, 
    ...
    Returns:
        Tuple[DocBin, Dict]: DocBin object and statistics about generation
    """
    print(f"🏗️  Generating {n_total} multi-country NLP training examples with noise...")
    print(f"📊 Balance mode: {'Enabled' if balance else 'Disabled'}")
    print(f"🎭 Noise generation: {'Enabled' if include_noise else 'Disabled'}")
    print(f"🔊 Noise level: {noise_level}")
    ...
    while created < n_total:
        ...
        try:
            # Generate example with selected country and noise
            text, annotations = generate_example_with_noise(country, include_noise, noise_level)
...
def make_country_docbin_with_noise(country: str = "chile",
    ...
    Returns:
        Tuple[DocBin, Dict]: DocBin object and statistics about generation
    """
    print(f"🏗️  Generating {n_total} {country.upper()} NLP training examples with noise...")
    print(f"📊 Balance mode: {'Enabled' if balance else 'Disabled'}")
    print(f"🎭 Noise generation: {'Enabled' if include_noise else 'Disabled'}")
    print(f"🔊 Noise level: {noise_level}")
