...
def generate_example_with_custom_mode(country: str = "chile", 
                                    ...
                                    noise_level: float = 0.15) -> Tuple[str, Dict[str, List[Tuple[int, int, str]]]]:
    """
    ...
    if mode == "full":
        ...
        template = random.choice(templates)
        sentence = template.format(complete_full_name, id_number)
        ...
        template = random.choice(templates)
        sentence = template.format(complete_full_name, address, city)
        ...
        template = random.choice(templates)
        sentence = template.format(complete_full_name, phone, email)
        ...
        template = random.choice(templates)
        sentence = template.format(complete_full_name, id_number, phone)
